...
Выполнили:
- Frontend: Кваша Таисия Андреевна, 20.Б12-пу
- Backend: Чередников Кирилл Алексеевич, 20.Б12-пу
...
2. **Обычный пользователь** - может оценивать, комментировать и добавлять в избранное статьи, редактировать свой никнейм и аватар, удалять собственные комментарии. Количество ограничено размером базы данных
3. **Модератор** - может добавлять статьи, редактировать созданные им статьи и удалять комментарии других пользователей. Количество ограничено размером базы данных
